...
void populate_monster_images(){
    for(int i=0;i<4;i++){
        sprintf(monster_idle[i], "spritedemo\\pinkmonster\\idleanim\\tile00%d.bmp", i);
    }
    for(int i=0;i<8;i++){
        sprintf(monster_jump[i], "spritedemo\\pinkmonster\\jumpanim\\tile00%d.bmp", i);
    }
    for(int i=0;i<6;i++){
        sprintf(monster_walk[i], "spritedemo\\pinkmonster\\walkanim\\tile00%d.bmp", i);
    }
